...
A NumPy implementation of a neural network that classifies handwritten digits from 0 to 9.
...
Type "python TASK.py" in a software like vs code after moving to the correct directory with TASK.py in it

This would run the neural network, User will be prompted via "Print accuracy on training iterations? (y/n): "
